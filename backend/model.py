...
class User(Base):
    ...
    assigned_departments_student = relationship(
        "StudentDepartment", back_populates="student", cascade="all, delete-orphan"
    )
...
class Course(Base):
    ...
    department_id = department_id = Column(
    ...
    assignments = relationship(
        "AssignmentTemplate", back_populates="course", cascade="all, delete-orphan"
    )
...
class AssignmentGrade(Base):
    ...
    submission_id = Column(
        Integer, ForeignKey("assignment_submissions.id"), nullable=False, unique=True
    )
...
class AssignmentTemplate(Base):
    ...
    lecturer = relationship(
        "User",
        back_populates="lecturer_assignment_submissions",
...
class AssignmentSubmission(Base):
    ...
    student = relationship(
        "User",
        back_populates="student_assignment_submissions",
...
class Department(Base):
    ...
    student_assignments = relationship(
        "StudentDepartment", back_populates="department", cascade="all, delete-orphan"
    )
...
class LecturerDepartmentAndLevel(Base):
    ...
    department = relationship("Department", back_populates="lecturer_assignments")
...
class StudentDepartment(Base):
    ...
    __table_args__ = (
        UniqueConstraint("student_id", "department_id", name="uix_student_department"),
    )
    ...
    student = relationship("User", back_populates="assigned_departments_student")
    department = relationship("Department", back_populates="student_assignments")


class StudentLevelProgress(Base):
    __tablename__ = "student_level_progress"
    __table_args__ = (
        UniqueConstraint("student_id", "session_id", name="uix_student_session_once"),
    )
...
class StudentPromotionLog(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    student_id = Column(Integer, ForeignKey("users.id"), nullable=False)
    promoted_from_level_id = Column(Integer, ForeignKey("levels.id"), nullable=False)
    promoted_to_level_id = Column(Integer, ForeignKey("levels.id"), nullable=True)
